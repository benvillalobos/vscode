		...
		const dialog = disposables.add(new Dialog(
			...
			createWorkbenchDialogOptions({
				...
				renderBody: container => {
					...
					const handle = renderForm(form, state, disposables, () => revalidate(), this.instantiationService, this.contextKeyService, this.contextViewService, this.configurationService, this.layoutService, initial?.prompt ?? '');
