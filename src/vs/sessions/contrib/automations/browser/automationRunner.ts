...
export class AutomationRunner implements IAutomationRunner {
	...
	private async _runOnceInner(
		...
		try {
			...
			const createOptions: ICreateNewSessionOptions | undefined = target.providerId !== undefined || target.sessionTypeId !== undefined || automation.modelId !== undefined || automation.mode !== undefined || automation.permissionLevel !== undefined || automation.providerConfiguration !== undefined || isolationMode !== undefined || branch !== undefined
				? {
					...
					...(automation.providerConfiguration ? { providerConfiguration: automation.providerConfiguration } : {}),
					isolationMode,
					branch,
				}
				: undefined;
